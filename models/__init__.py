...
# @Author : system
# @Version : 0.2.5
# @Program : 初始化 自定义 (网络结构实例) | Initialize Custom (network structure example)
# @File : __init__.py
# @Description : 定义 初始化 自定义 (网络结构实例) | Definition Initialize Custom (network structure example)
